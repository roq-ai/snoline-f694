...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'member', 'manager', 'employee'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Clients', path: '/clients', entity: 'client', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    ...
    { name: 'Teams', path: '/teams', entity: 'team', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
