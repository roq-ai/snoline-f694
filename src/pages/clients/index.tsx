...
export function ClientListPage(props: ClientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getClients({
        relations: ['service', 'service_request.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['first_name.contains', 'last_name.contains', 'contact_number.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'email_id', header: 'Email Id', accessorKey: 'email_id' },
