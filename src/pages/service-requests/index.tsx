  ...
  const columns: ColumnType[] = [
    { id: 'status', header: 'Status', accessorKey: 'status' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.requested_date ? format(parseISO(record?.requested_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'completed_date',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.completed_date ? format(parseISO(record?.completed_date as unknown as string), 'dd-MM-yyyy') : '',
    },
