...
export function ServiceListPage(props: ServiceListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getServices({
        relations: ['organization', 'client.count', 'service_request.count', 'team.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'charge', header: 'charge', accessorKey: 'charge' },
    ...
    hasAccess('client', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Client',
          accessorKey: 'client',
          cell: ({ row: { original: record } }: any) => record?._count?.client,
        }
      : null,
