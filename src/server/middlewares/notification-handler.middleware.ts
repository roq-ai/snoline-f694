...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'service_request.create': {
    roles: ['owner', 'manager', 'member', 'employee'],
    key: 'service-request-created',
    tenantPath: ['organization', 'service', 'service_request'],
    userPath: [],
  },
  'service_request.update': {
    roles: ['owner', 'manager', 'member', 'employee'],
    key: 'service-request-updated',
    tenantPath: ['organization', 'service', 'service_request'],
    userPath: [],
  },
  'service_request.delete': {
    roles: ['owner', 'manager', 'member', 'employee'],
    key: 'service-request-deleted',
    tenantPath: ['organization', 'service', 'service_request'],
    userPath: [],
  },
};
